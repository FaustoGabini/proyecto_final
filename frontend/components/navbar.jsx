import { Brain, Home, Compass, Menu, Waves, Building2, MapPin, Mouse as House, ChevronDown } from "lucide-react"
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="center" className="w-56">
                <DropdownMenuItem asChild>
                  <Link href="/resultados?tipo=frente-al-mar" className="flex items-center gap-3 cursor-pointer">
                ...
                <DropdownMenuItem asChild>
                  <Link href="/resultados?tipo=cerca-de-retiro" className="flex items-center gap-3 cursor-pointer">
                    <MapPin className="h-5 w-5 text-primary" />
                    <span>Cerca de Retiro</span>
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/resultados?tipo=barrio-privado" className="flex items-center gap-3 cursor-pointer">
